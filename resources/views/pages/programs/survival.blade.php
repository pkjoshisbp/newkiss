...
@section('title', 'Survival Swimming Program - K.I.S.S. Aquatics')
@section('description', 'Learn essential water safety and survival swimming skills. Our survival program teaches children to swim, float, and survive in emergency situations.')
            ...
            <div class="row g-4">
                @php
                    $locations = App\Models\Location::with(['pricingPlans' => function($query) {
                        $query->where('program_name', 'Survival Program');
