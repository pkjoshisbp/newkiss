...
@section('title', 'Frequently Asked Questions - K.I.S.S. Aquatics')
@section('description', 'Find answers to common questions about K.I.S.S. Aquatics swimming lessons, programs, safety protocols, and enrollment process.')
